...
![Создание учётной записи](image/img01){ #fig:001 width=70% }
...
![Синхронизация учётной записи](image/img02){ #fig:002 width=70% }

![Создание нового ssh ключа](image/img03){ #fig:003 width=70% }

![Добавление ssh ключа на github](image/img04){ #fig:004 width=70% }

![Привязка через консоль](image/img05){ #fig:005 width=70% }
...
![Создание нового репозитория](image/img06){ #fig:006 width=70% }

Создаем рабочий каталог (рис. -@fig:007).

![Создание рабочего каталога](image/img07){ #fig:007 width=70% }
...
![Добавляем первый commit](image/img08){ #fig:008 width=70% }
...
![Просматриваем список шаблонов](image/img09){ #fig:009 width=70% }

![Скачиваем шаблон и отправляем на github](image/img10){ #fig:010 width=70% }
